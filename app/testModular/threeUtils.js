...
// In utils/threeUtils.js, update the add3DObject function:
...
const add3DObject = (scene, object) => {
  ...
  switch(object.type) {
    ...
    case 'ball':
      material = new THREE.MeshStandardMaterial({ color: 0x3366ff });
      geometry = new THREE.SphereGeometry(object.width / 40, 32, 32);
      mesh = new THREE.Mesh(geometry, material);
      mesh.position.set(normalizedX, normalizedY, 0);
...
// New function to create a texture with text
