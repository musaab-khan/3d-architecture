...
const Page = () => {
    ...
    return (
        ...
        <div className='flex flex-col items-center text-white justify-evenly py-10 relative' style={{ background: 'linear-gradient(90deg, #181818, #424242)' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-[2%] mb-4 mt-[-22%] md:mt-[-5%] w-[65%] relative text-2xl">
                <div className='w-[45vw] md:w-[20vw] h-[22vh] m-auto flex justify-center items-center rounded-xl cursor-pointer' onClick={handleCreateNewClick} style={{background: "linear-gradient(#BFB145,#6D6BE3,#5F5FFF)"}}>
